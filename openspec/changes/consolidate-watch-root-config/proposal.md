...
- **BREAKING** Replace `TOTAL_RECALL_AUDIO_WATCH_PATH`, `TOTAL_RECALL_PDF_WATCH_PATH`, `TOTAL_RECALL_IMAGE_WATCH_PATH`, and `TOTAL_RECALL_TEXT_WATCH_PATH` with one root setting.
